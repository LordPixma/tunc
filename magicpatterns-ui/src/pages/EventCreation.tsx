        ...
        {step === 3 && <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              ...
              <button
                ...
                disabled={loading}
                className="flex-1 py-3 rounded-lg bg-gradient-to-r from-orange-500 to-pink-500 text-white font-medium hover:opacity-90 transition-opacity text-center disabled:opacity-50"
              >
